...
- 附加判断：`has_local_temp_disk`、`is_network_optimized`、`sap_possible`
...
### 单条解析
`python skills/vm-aws-instance-to-config/scripts/aws_instance_indicators.py --instance-type "m6a.4xlarge"`

### 批量解析（CSV）
`python skills/vm-aws-instance-to-config/scripts/aws_instance_indicators.py --input-file "input/aws_types.csv" --column "instance_type" --output "output/aws_indicators.csv"`
...
## 参考材料
- `references/aws-size-to-vcpu-rules.md`
- `references/aws-memory-heuristics.md`
- `references/sap-eligibility-heuristics.md`
